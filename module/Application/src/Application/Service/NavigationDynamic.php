    ...
    protected function getPages(ServiceLocatorInterface $serviceLocator)
    {
        ...
        if (null === $this->pages) {
	       ...
	       //var_dump($routeMatch->getMatchedRouteName());
	        ...
	        $translit = 0;
	        if(!empty($routeMatch)){
		        if($routeMatch->getMatchedRouteName() == 'home/genre/one/book'
			        or $routeMatch->getMatchedRouteName() == 'home/genre/one/book/read'
			        or $routeMatch->getMatchedRouteName() == 'home/genre/one/book/content'
		        ){
		        ...
		        $pageBook = $serviceLocator->get('Application\Model\TextTable')
			        ->fetchAll(false, false, $where);
		        $pageBookCount = $pageBook->count();


		        $where = "id_main = '{$book['id']}'";
		        $soder = $serviceLocator->get('Application\Model\SoderTable')
			        ->fetchAll(false, false, $where);
					}
	        }
	        elseif($routeMatch->getMatchedRouteName() == 'home/authors/one'
		        or $routeMatch->getMatchedRouteName() == 'home/authors/one/book'
		        or $routeMatch->getMatchedRouteName() == 'home/authors/one/book/read'
		        or $routeMatch->getMatchedRouteName() == 'home/authors/one/book/content'
	        ){
		        $alias_author = $routeMatch->getParam('alias_menu');
		        $where = "m_avtor.alias = '{$alias_author}'";
		        $avtor = $serviceLocator->get('Application\Model\MAvtorTable')
			        ->joinAvtor()
			        ->joinBook()
			        ->fetchAll(false, false, $where);
	        ...
	        elseif($routeMatch->getMatchedRouteName() == 'home/series/one'
		        or $routeMatch->getMatchedRouteName() == 'home/series/one/book'
		        or $routeMatch->getMatchedRouteName() == 'home/series/one/book/read'
		        or $routeMatch->getMatchedRouteName() == 'home/series/one/book/content'
	        ){
		        $alias_series = $routeMatch->getParam('alias_menu');
		        $where = "m_serii.alias = '{$alias_series}'";
		        $serii = $serviceLocator->get('Application\Model\MSeriiTable')
			        ->joinSerii()
			        ->joinBook()
			        ->fetchAll(false, false, $where);
		        ...
		        elseif($routeMatch->getMatchedRouteName() == 'home/translit/one'
			        or $routeMatch->getMatchedRouteName() == 'home/translit/one/book'
			        or $routeMatch->getMatchedRouteName() == 'home/translit/one/book/read'
			        or $routeMatch->getMatchedRouteName() == 'home/translit/one/book/content'
		        ){
			        $alias_series = $routeMatch->getParam('alias_menu');
			        $where = "m_translit.alias = '{$alias_series}'";
			        $translit = $serviceLocator->get('Application\Model\MTranslitTable')
				        ->joinTranslit()
				        ->joinBook()
				        ->fetchAll(false, false, $where);
