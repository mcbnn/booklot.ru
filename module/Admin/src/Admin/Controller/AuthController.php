...
class AuthController extends AbstractActionController
{
    ...
    {	
        ...
        if ($this->getAuthService()->hasIdentity()) {
	        return $this->redirect()->toRoute( 'home/slash', array( 'action' => 'index', 'subdomain' => 'www.booklot.ru' ) );
        }
        $form = $this->getForm();
    ...
    public function logoutAction()
    {
        ...
        return $this->redirect()->toRoute('home/slash',array('subdomain'=>'www.booklot.ru'));
    }
}